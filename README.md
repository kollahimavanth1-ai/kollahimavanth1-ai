...
const himavanth: Developer = {
  name     : "Kolla Himavanth",
  role     : "Frontend Developer",
  exp      : "2 Years",
  location : "India 🇮🇳",
  stack    : ["C", "C++", "DSA", "Python",
              "React", "TypeScript", "Node.js"],
  status   : "Open to Opportunities 🟢",
  motto    : "Great UI = Art × Logic"
};
```

<br/>

I'm a **passionate Frontend Developer** with **2 years** of hands-on experience building fast, responsive, and visually stunning web applications. I bridge the gap between **design and engineering** — writing clean, scalable code that users love to interact with.

- 🔭 &nbsp; Currently crafting **modern React + TypeScript** applications
- 🧠 &nbsp; Sharpening my **DSA & problem-solving** skills daily
- 🎨 &nbsp; I obsess over **pixel-perfect UIs** and smooth micro-interactions
- 💡 &nbsp; Fun fact: I've fixed more bugs **at 2 AM** than in daylight ☕🌙
- 🤝 &nbsp; Always open to **collabs, freelance & full-time roles**
- 📖 &nbsp; Constantly learning — *"Ship fast, learn faster"*
...
**I'm always open to exciting projects, meaningful collabs, and good conversations.**
**If you have an idea, let's turn it into reality. 🚀**
